...
function GroupForm({
  ...
  const setGroupPop = popups((state) => state.setGroupPop);
    ...
    >
      ...
      <div className="flex gap-4">
        ...
        <input
          ...
          onChange={nameChange}
          className={`w-50 py-1 bg-[#222834] rounded-md px-2 focus:outline-none placeholder:text-gray-600 text-white`}
        />
      </div>
      <div className="flex gap-4">
        ...
        <select
          ...
          className={`${
            dropColor ? "text-white" : "text-gray-600"
          } hover:cursor-pointer w-full bg-[#222834] rounded-2xl px-2`}
        >
